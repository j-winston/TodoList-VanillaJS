...
/******/ (() => {
  ...
  \************************************/
      /***/ (
        ...
        eval(
          '__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _pubsub__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./pubsub */ "./src/pubsub.js");\n/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./storage */ "./src/storage.js");\n/* harmony import */ var _projectController__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./projectController */ "./src/projectController.js");\n/* harmony import */ var _taskController__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./taskController */ "./src/taskController.js");\n//Module: controllerInterface.js\n//Role: Bridge\n//Responsibilities: Subscribe to events pubblished from the DOM and pass on to appropriate controller.\n//\n\n\n\n\n\nconst controllerInterface = (() => {\n  const addTask = (formValues) => {\n    const task = _projectController__WEBPACK_IMPORTED_MODULE_2__["default"].addTaskToProject(formValues);\n\n    if (task) {\n      _pubsub__WEBPACK_IMPORTED_MODULE_0__["default"].publish("taskAdded", task);\n    }\n  };\n\n  const getProject = (project) => {\n    let name = "";\n\n    if (project === "Inbox") {\n      name = "Inbox";\n    } else {\n      name = project.name;\n    }\n    _projectController__WEBPACK_IMPORTED_MODULE_2__["default"].findProject(name);\n  };\n\n  const addNewProject = (name) => {\n    const project = _projectController__WEBPACK_IMPORTED_MODULE_2__["default"].createNewProject(name);\n    _pubsub__WEBPACK_IMPORTED_MODULE_0__["default"].publish("newProjectSaved", project);\n  };\n\n  const deleteProject = (projId) => {\n    if (_projectController__WEBPACK_IMPORTED_MODULE_2__["default"].remove(projId)) {\n      return true;\n    }\n  };\n\n  const delTask = (task) => {\n    const projName = task.getProjectName();\n    const project = _storage__WEBPACK_IMPORTED_MODULE_1__["default"].loadProject(projName);\n    const taskIndex = project.tasks.indexOf(task);\n\n    project.tasks.splice(taskIndex, 1);\n    _storage__WEBPACK_IMPORTED_MODULE_1__["default"].saveProject(project);\n  };\n\n  const updateTask = (formValues) => {\n    _taskController__WEBPACK_IMPORTED_MODULE_3__["default"].update(formValues);\n  };\n\n  const getAllProjects = () => {\n    const projectsArr = _projectController__WEBPACK_IMPORTED_MODULE_2__["default"].loadAllProjects();\n    // maybe error checking here?\n\n    _pubsub__WEBPACK_IMPORTED_MODULE_0__["default"].publish("allProjectsRetrieved", projectsArr);\n  };\n\n  const renderInbox = () => {\n    _projectController__WEBPACK_IMPORTED_MODULE_2__["default"].createNewProject({\n      name: "Inbox",\n      id: "djas939u234asd",\n    });\n  };\n\n  // Subcriptions\n  // pubSub.subscribe("addProjectFormSubmitted", addNewProject);\n  //pubSub.subscribe("projectClicked", getProject);\n  //pubSub.subscribe("projectRemoved", removeProject);\n\n  //pubSub.subscribe("taskSubmitted", addTaskToProject);\n  //pubSub.subscribe("taskEditSubmitted", updateTask);\n  // pubSub.subscribe("taskDeleted", delTask);\n\n  return {\n    getAllProjects,\n    addNewProject,\n    addTask,\n    deleteProject,\n  };\n})();\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (controllerInterface);\n\n\n//# sourceURL=webpack://lesson-13-project-mytodo/./src/controllerInterface.js?'
        );
